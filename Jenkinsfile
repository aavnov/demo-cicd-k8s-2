  ...
  ]) 
{
    node(POD_LABEL) {
    def dockerImage
    def imagename = "192.168.1.39:5000/demo-cicd-k8s-2-app:latest"
        ...
        stage('Build image'){
            container('docker') {
                ...
                //dockerImage = docker.build("vasilvedev/demo-cicd-k8s-2-app:latest","/home/jenkins/agent/workspace/my-345/demo-cicd-k8s-2")
